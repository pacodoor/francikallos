...
function renderTimer(b){
  ...
  return `<div class="timer-top">
    ...
    <div class="timer-controls">
      <button class="timer-btn timer-btn-start" id="tbtn-${bid}" onclick="timerAction('${bid}','start',${JSON.stringify(b).replace(/'/g,"&#39;")})">Iniciar</button>
      <button class="timer-btn timer-btn-reset" onclick="timerReset('${bid}',${JSON.stringify(b).replace(/'/g,"&#39;")})">Reset</button>
    </div>`;
}
...
function timerAction(bid,action,b){
